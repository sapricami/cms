...
class Siteoptions extends CI_Controller {
	...
	public function index()
	{
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				...
				array('link'=>'Siteoptions','title'=>'Site Options','active'=>true,),
			),
		);
		$this->data['current_slug']='siteoptions';
		$this->common->layout('siteoptions',$this->data);		
	}
	public function information()
	{
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'siteoptions','title'=>'Site Options','active'=>false,),
				array('link'=>'siteoptions/information','title'=>'Information','active'=>true,),
			),
		);
		if($this->input->post()){
		...
		$this->common->layout('siteoptions_information',$this->data);		
	}
	public function settings()
	{
		...
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'siteoptions','title'=>'Site Options','active'=>false,),
				array('link'=>'siteoptions/settings','title'=>'Settings','active'=>true,),
			),
		);
		if($this->input->post()){
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$this->db->update('cms_options',$data_db);
				$this->session->set_flashdata('message',alert('success','Information Updated'));
				redirect('siteoptions/settings/','refresh');
			}
		}
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('siteoptions_settings',$this->data);		
	}
	public function seo_settings()
	{
		...
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'siteoptions','title'=>'Site Options','active'=>false,),
				array('link'=>'siteoptions/seo_settings','title'=>'Seo Settings','active'=>true,),
			),
		);
		if($this->input->post()){
			$this->form_validation->set_rules('maintainence_mode', 'maintainence_mode', 'trim');
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$this->db->update('cms_options',$data_db);
				$this->session->set_flashdata('message',alert('success','Information Updated'));
				redirect('siteoptions/seo_settings/','refresh');
			}
		}
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('siteoptions_seosettings',$this->data);		
	}
	public function email()
	{
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'siteoptions','title'=>'Site Options','active'=>false,),
				array('link'=>'siteoptions/email','title'=>'Email','active'=>true,),
			),
		);
		if($this->input->post()){
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$this->db->update('cms_options',$data_db);
				$this->session->set_flashdata('message',alert('success','Information Updated'));
				redirect('siteoptions/email/','refresh');
			}
		}
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('siteoptions_email',$this->data);		
	}
	public function email_test(){
		...
		if($this->input->post()){
			...
			if ($this->form_validation->run() == TRUE) {
				...
				redirect('siteoptions/email_test/','refresh');
			}
		}

		$this->data['current_slug']='siteoptions_email_test';
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('siteoptions_email_test',$this->data);		
	}
