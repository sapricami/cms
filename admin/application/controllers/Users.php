...
class Users extends CI_Controller {
	...
	public function index(){
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				...
				array('link'=>'users','title'=>'Users','active'=>true,),
			),
		);
		$this->data['current_slug']='users';
		$this->common->layout('users',$this->data);		
	}
	public function add_user()
	{
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/all_users','title'=>'All Users','active'=>false,),
				array('link'=>'users/add_user','title'=>'Add User','active'=>true,),
			),
		);
		...
		if ($this->input->post()) {
			...
			if ($this->form_validation->run() == TRUE) {
				...
				if ($this->db->insert('admin_users',$data_db)) {
					...
					redirect('users/all_users/','refresh');
				}else{
		...
		$this->common->layout('users_add_user',$this->data);		
	}
	public function edit_user($id){
		...
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				...
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/all_users','title'=>'All Users','active'=>false,),
				array('link'=>'users/edit_user','title'=>'Edit User','active'=>true,),
			),
		);		
	...
	public function all_users(){
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/all_users','title'=>'All Users','active'=>true,),
			),
		);
		/**/
		$sql = $this->db->query("
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('users_all_users',$this->data);		
	}
	public function add_group(){
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/all_groups','title'=>'All Groups','active'=>false,),
				array('link'=>'users/add_group','title'=>'Add Group','active'=>true,),
			),
		);
		...
		if ($this->input->post()) {
			...
			if (($this->form_validation->run() == TRUE)&&($this->db->insert('admin_groups',$data_db))) {
				...
				redirect('users/all_groups/','refresh');
			}
		}
		...
		$this->data['current_slug']='add_user';
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('users_add_group',$this->data);	
	}
	public function edit_group($id){
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				...
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/all_groups','title'=>'All Groups','active'=>false,),
				array('link'=>'users/edit_group','title'=>'Edit Group','active'=>true,),
			),
		);
		/**/
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('users_edit_group',$this->data);	
	}
	public function all_groups(){
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/all_groups','title'=>'User Groups','active'=>true,),
			),
		);
		/**/
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('users_all_groups',$this->data);
	}
	public function permissions(){
		$this->data['page_data']=array(
			...
			'breadcrumb' => array(
				array('link'=>'dashboard','title'=>'Dashboard','active'=>false,),
				array('link'=>'users','title'=>'Users','active'=>false,),
				array('link'=>'users/permissions','title'=>'Users Permissions','active'=>true,),
			),
		);
		/**/
		...
		$this->data['message']=$this->session->flashdata('message');
		$this->common->layout('users_permissions',$this->data);		
	}
