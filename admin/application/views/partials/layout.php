                    ...
                    <div class="site-header-shown">
                        ...
                        <div class="dropdown user-menu">
                            <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?=main_url()?>uploads/admins/<?=$user_data['admin_photo']?>" alt="">
                            </button>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
                                <a class="dropdown-item" href="<?=base_url()?>profile"><span class="font-icon glyphicon glyphicon-user"></span>Profile</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?=base_url()?>login/logout"><span class="font-icon glyphicon glyphicon-log-out"></span>Logout</a>
                            </div>
                        </div>
                    ...
                    <div class="site-header-collapsed">
                        <div class="site-header-collapsed-in">
                            <div class="dropdown dropdown-typical">
                                <a class="external-link" href="<?=main_url()?>" target="_blank">Site Preview <i class="fa fa-external-link"></i></a>
                            </div>
                            <?php /* ?>
                            <div class="dropdown dropdown-typical">
