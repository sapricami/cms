		...
		<tbody>
			...
			<tr id="trrow_<?=$row['page_id']?>">
				...
				<td class="">
					...
					<a href="<?=main_url().$row['page_slug']?>" target="_blank">link</a>
				</td>
				...
				<td class="">
					<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                       <div class="btn-group btn-group-sm" style="float: none;">
                       		<a href="<?=base_url()?>pages/edit_page/<?=$row['page_id']?>" class="tabledit-edit-button btn btn-sm btn-default" style="float: none;" target="_blank"><span class="glyphicon glyphicon-pencil"></span> Meta</a>
                       		<a href="<?=base_url()?>pages/edit_page_content/<?=$row['page_id']?>" class="tabledit-edit-button btn btn-sm btn-default" style="float: none;" target="_blank"><span class="glyphicon glyphicon-pencil"></span> Content</a>
		...
		function(isConfirm) {
			if (isConfirm) {	
				...
				$.ajax({
					type: "POST",
					dataType: "json",
					url:'<?=base_url()?>pages/api_delete_page',
					data:{id:id_to_del},
