...
<div class="col-md-12">
	<div class="page-content">
		<div class="container-fluid">
			<header class="section-header">
				<h3></h3>
				<ul class="breadcrumb">
					<li><a href="<?=base_url()?>dashboard"><i class="fa fa-home"></i> Dashboard</a>  >  <a href="<?=base_url()?>pages"><i class="fa fa-list-ul"></i> Pages</a>  >  <i class="fa fa-list-ul"></i> Edit Page Content</li>
				</ul>
			</header>
    ...
    <script type="text/javascript">
        ...
        SirTrevor.setDefaults({
		  	uploadUrl: '<?=base_url()?>pages/api_sir_trevor_image_upload'
		});
