		...
		<div class="row">
			<div class="col-md-12">
				<form method="post">
					...
					<div class="form-group row">
						<label class="col-sm-2 form-control-label">Site Description</label>
						<div class="col-sm-10">
							<p class="form-control-static"><textarea class="form-control" name="site_description" placeholder=""><?=$siteoptions['site_description'];?></textarea></p>
						</div>
					</div>
					<div class="form-group row">
